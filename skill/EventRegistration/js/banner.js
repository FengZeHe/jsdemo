(function () {
  ...
  var lbtn = $('.banner-pointer-left')
  var rbtn = $('.banner-pointer-right')
  lbtn.onclick = toPre;
  rbtn.onclick = toNext;
  ...
  function toPre() {
    currentCoverIndex = currentCoverIndex - 1 < 0 ? 3 : currentCoverIndex - 1
    change(currentCoverIndex)
  }

  function toNext() {
    currentCoverIndex = currentCoverIndex + 1 > 3 ? 0 : currentCoverIndex + 1
    change(currentCoverIndex)
  }
